...
def main():
    ...
    print("    - Earth's observed eccentricity variation is already fully")
    print("      accounted for by Jupiter and Venus (Milankovitch), so there is")
    print("      no unexplained residual for a shedding event to occupy.")
    print()
